...
declare global {
  ...
  const useTransformerDesign: typeof import('../../composables/useTransformerDesign').useTransformerDesign
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { TransformerRequirements, CoreSelection, WindingDesign, LossAnalysis, ThermalAnalysis, VerificationStatus, TransformerDesignResult, DesignSuggestion, CoreAlternative, NoMatchResult } from '../../composables/useTransformerDesign'
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useTransformerDesign: UnwrapRef<typeof import('../../composables/useTransformerDesign')['useTransformerDesign']>
